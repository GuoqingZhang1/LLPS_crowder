...
k_12,b_12=op.curve_fit(f_tau_Q,np.log(Q_12),np.log(tau_12),maxfev = 100000000,xtol=0.0001,ftol=0.0001,gtol=0.0001)[0]

k_1h,b_1h=op.curve_fit(f_tau_Q,np.log(Q_1h),np.log(tau_1h),maxfev = 100000000,xtol=0.0001,ftol=0.0001,gtol=0.0001)[0]

k_hh,b_hh=op.curve_fit(f_tau_Q,np.log(Q_hh),np.log(tau_hh),maxfev = 100000000,xtol=0.0001,ftol=0.0001,gtol=0.0001)[0]
...
plt.plot(xx,np.exp(f_tau_Q(np.log(xx),k_12,b_12)),color='black',linestyle='--',linewidth=4.0,zorder=1)
...
plt.savefig('Q_tau_12_s_%d.png' %(Per),bbox_inches='tight',dpi=1000)
plt.close()
...
plt.plot(xx,np.exp(f_tau_Q(np.log(xx),k_1h,b_1h)),color='black',linestyle='--',linewidth=4.0,zorder=1)
...
plt.legend(prop = {'size':26,'family':'Arial'},frameon=False,edgecolor ='black')
fig.set_size_inches(10,6)
plt.savefig('Q_tau_1h_s_%d.png' %(Per),bbox_inches='tight',dpi=1000)
plt.close()
...
plt.plot(xx,np.exp(f_tau_Q(np.log(xx),k_hh,b_hh)),color='black',linestyle='--',linewidth=4.0,zorder=1)
...
plt.legend(prop = {'size':26,'family':'Arial'},frameon=False,edgecolor ='black')
fig.set_size_inches(10,6)
plt.savefig('Q_tau_hh_s_%d.png' %(Per),bbox_inches='tight',dpi=1000)
plt.close()
