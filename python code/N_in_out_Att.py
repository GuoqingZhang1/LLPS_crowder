...
axx1.set_yticks([0.005,0.015,0.025])
axx1.set_yticklabels(["0.005","0.015","0.025"],fontproperties='Arial',fontsize=36,color='darkorange')
...
axx2.set_yticks([1,3,5])
axx2.set_yticklabels(["1","3","5"],fontproperties='Arial',fontsize=36,color='darkgreen')
