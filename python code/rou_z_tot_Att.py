...
for i in range(14):
    plt.plot(np.arange(0,50,0.1),rou_all_pro[i]+0.6,linewidth=4.0,color=cmap1((i+1)/15))
    plt.plot(np.arange(0,50,0.1),rou_all_cro[i],linestyle='--',dashes=(10,1),linewidth=4.0,color=cmap1((i+1)/15))
...
# for i in range(14):
#     ax_inset.plot(np.arange(0,50,0.1),rou_all_pro[i],linewidth=4.0,color=cmap1((i+1)/15))
