...
Inter_2=Inter_double
for i in range(148):
    for j in range(148):
        if j>i:
            Inter_2[i][j]=Inter[i][j]
...
ax5 = fig5.gca()
im5 = ax5.imshow(Inter_2,cmap='hot_r',origin='lower',norm=LogNorm(vmin=0.00001,vmax=0.1))
...
fig5.savefig('Inter_2_map_%d.png' %(Per))
plt.close()

Intra_2=np.zeros([148,148])

Intra_2=Intra_single
for i in range(148):
    for j in range(148):
        if j>i:
            Intra_2[i][j]=Intra[i][j]
...
ax5 = fig5.gca()
im5 = ax5.imshow(Intra_2,cmap='hot_r',origin='lower',norm=LogNorm(vmin=0.00001,vmax=0.1))
cb5 = plt.colorbar(im5,pad=0.05)
cb5.ax.tick_params(labelsize=20)
...
plt.yticks([0,49,99,147],labels=['1','50','100','148'],fontproperties='Arial',size=24)
plt.subplots_adjust(bottom=0.2,left=0.2)
fig5.savefig('Intra_2_map_%d.png' %(Per))
plt.close()

fig=plt.figure(figsize=(8,2),dpi=1000)
plt.bar(np.arange(148), Inter_index_double,color='orangered')
...
plt.yticks([0,0.2,0.4],fontproperties='Arial',fontsize=36)
# plt.ylim(0,0.0002)
plt.xlim(-2,150)
...
plt.savefig('Inter_index_double_%d.png' %(Per),dpi=1000,bbox_inches='tight')
plt.close()

fig=plt.figure(figsize=(8,2),dpi=1000)
plt.bar(np.arange(148), Inter_index,color='orangered')
plt.xlabel('Residues index',labelpad=10,fontproperties='Arial',size=40)
plt.ylabel(u'$\mathregular{N_{c}}$',labelpad=10,fontproperties='Arial',size=40)
plt.xticks([0,49,99,147],['1','50','100','148'],fontproperties='Arial',fontsize=36)
plt.yticks([0,4,8],fontproperties='Arial',fontsize=36)
# plt.ylim(0,0.0002)
plt.xlim(-2,150)
plt.tick_params(length=7,pad=10,width = 2,direction='in')
bwith = 2 #边框宽度设置为2
...
fig=plt.figure(figsize=(8,2),dpi=1000)
plt.bar(np.arange(148), Intra_index_single,color='orangered')
plt.xlabel('Residues index',labelpad=10,fontproperties='Arial',size=40)
plt.ylabel(u'$\mathregular{N_{c}}$',labelpad=10,fontproperties='Arial',size=40)
plt.xticks([0,49,99,147],['1','50','100','148'],fontproperties='Arial',fontsize=36)
plt.yticks([0,4,8],fontproperties='Arial',fontsize=36)
...
# plt.legend(prop = {'size':14},frameon=True,edgecolor ='black',shadow=True)
fig.set_size_inches(8,2)
plt.savefig('Intra_index_single_%d.png' %(Per),dpi=1000,bbox_inches='tight')
plt.close()

fig=plt.figure(figsize=(8,2),dpi=1000)
plt.bar(np.arange(148), Intra_index,color='orangered')
plt.xlabel('Residues index',labelpad=10,fontproperties='Arial',size=40)
plt.ylabel(u'$\mathregular{N_{c}}$',labelpad=10,fontproperties='Arial',size=40)
plt.xticks([0,49,99,147],['1','50','100','148'],fontproperties='Arial',fontsize=36)
plt.yticks([0,4,8],fontproperties='Arial',fontsize=36)
