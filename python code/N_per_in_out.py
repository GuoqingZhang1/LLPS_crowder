...
axx1.set_yticks([0.0005,0.0015,0.0025])
axx1.set_yticklabels(["0.05","0.15","0.25"],fontproperties='Arial',fontsize=36,color='darkorange')
...
axx2.set_yticks([0.9975,0.9985,0.9995])
axx2.set_yticklabels(["99.75","99.85","99.95"],fontproperties='Arial',fontsize=36,color='darkgreen')
