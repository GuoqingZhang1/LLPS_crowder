...
for Per in [-0.05,-0.10,-0.15,-0.20,-0.25,-0.30]:
    ...
    N_in_per.append(N_in/(N_in+N_out))
    N_out_per.append(N_out/(N_in+N_out))
...
axx1.set_xlabel('C'+'$\mathregular{_{Att}}$'+" (%)",size=40,labelpad=10,fontproperties="Arial")
axx1.set_ylabel(u'$\mathregular{P^{N}_{in}}$'+" (%)",labelpad=10,size=40,fontproperties="Arial",color='darkorange')
axx1.set_xticks([0.5,1.0,1.5,2.0,2.5,3.0])
axx1.set_xticklabels(["5","10","15","20","25","30"],fontproperties='Arial',fontsize=36)
axx1.set_yticks([0.003,0.005,0.007])
axx1.set_yticklabels(["0.3","0.5","0.6"],fontproperties='Arial',fontsize=36,color='darkorange')
...
axx2.set_xlabel('C'+'$\mathregular{_{Att}}$'+" (%)",size=40,labelpad=10,fontproperties="Arial")
axx2.set_ylabel(u'$\mathregular{P^{N}_{out}}$'+" (%)",labelpad=10,size=40,fontproperties="Arial",color='darkgreen')
axx2.set_xticks([0.5,1.0,1.5,2.0,2.5,3.0])
axx2.set_xticklabels(["5","10","15","20","25","30"],fontproperties='Arial',fontsize=36)
axx2.set_yticks([0.993,0.995,0.997])
axx2.set_yticklabels(["99.3","99.5","99.7"],fontproperties='Arial',fontsize=36,color='darkgreen')
