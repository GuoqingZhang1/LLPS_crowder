...
for Per in ['0','5','10','15','20','25','30']:
    f_pro=open('../Crowd_'+Per+'/Rg_llps.txt','r')
...
plt.yticks([0.0,0.002,0.004,0.006],['0','0.2','0.4','0.6'],fontproperties='Arial',fontsize=36)
plt.xlim(0,82)
...
plt.savefig('Rg_llps.png',dpi=1000,bbox_inches='tight')